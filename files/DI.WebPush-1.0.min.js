...
firebase.initializeApp({apiKey: 'AIzaSyDhT3n_qnl8xoxAlbGqb2n2VRwjwcBJVE0',
                ...
                });var n=firebase.messaging();function r(){return null!=window.localStorage.getItem("ContactIdentifier")}function i(){if(!r()){var e=window.DI.util.getURLParameters();if(void 0!==e.oft_id&&void 0!==e.oft_k){var t={id:e.oft_id,key:e.oft_k,identificationType:"sendlog"};window.localStorage.setItem("ContactIdentifier",JSON.stringify(t))}else if(void 0!==e.oft_c&&void 0!==e.oft_ck){t={id:e.oft_c,key:e.oft_ck,identificationType:"contact"};window.localStorage.setItem("ContactIdentifier",JSON.stringify(t))}r()&&l()&&n.getToken().then(function(e){o(e)}).catch(function(e){console.log("Unable to retrieve token",e)})}}function o(e){if(l())console.log("Token already sent to server so won't send it again unless it changes");else{console.log("Sending token to server..."),i();var n=window.localStorage.getItem("ContactIdentifier"),r=null,o=null,a=null;null!=n&&("contact"==(r=n.identificationType)||"sendlog"==r?o=n.id+":"+n.key:"project"==r&&(a=n.keys));var u={ApplicationId:t,ContactIdentificationType:r,ContactIdentification:o,Fields:a,Token:e,Domain:location.host,Language:(window.navigator.userLanguage||window.navigator.language).substring(0,2)};window.DI.util.net.corsAjax({url:"https://lightspeed.dev.ofsys.com/webservices/ofc4/push.ashx?method=SetToken",data:JSON.stringify(u),success:function(e){console.log(e),null!=n&&s(!0)},error:function(e,t){console.log(e),console.log(t)}})}}function l(){return 1==window.localStorage.getItem("sentToServer")}function s(e){window.localStorage.setItem("sentToServer",e?1:0)}n.onTokenRefresh(function(){n.getToken().then(function(e){s(!1),o(e)}).catch(function(e){console.log("Unable to retrieve refreshed token",e)})}),n.onMessage(function(e){console.log("onMessage :Message received. ",e),function(e){if(!Notification||"granted"!==Notification.permission||document.hidden)return;navigator.serviceWorker.getRegistration("/firebase-cloud-messaging-push-scope").then(function(t){t.active.postMessage({showNotification:e})}).catch(function(e){console.log(e)})}(e)}),e.Init=function(){i()},e.Identify=function(){var e={};if(1===arguments.length&&arguments[0].constructor==={}.constructor)for(var t in arguments[0])e[t]=arguments[0][t];else if(1===arguments.length&&arguments[0].constructor===[].constructor&&arguments[0].length%2==0)for(var n=0;n<arguments[0].length;n++)n%2==0&&"string"==typeof(t=arguments[0][n])&&0===t.indexOf("f_")&&(e[t]=arguments[0][n+1]);else{if(!(arguments.length>0&&arguments.length%2==0))throw"invalid parameters";for(n=0;n<arguments.length;n++)n%2==0&&"string"==typeof(t=arguments[n])&&0===t.indexOf("f_")&&(e[t]=arguments[n+1])}var r={keys:e,identificationType:"project"};window.localStorage.setItem("ContactIdentifier",JSON.stringify(r))},e.RequestPermission=function(){n.requestPermission().then(function(){n.getToken().then(function(e){e?o(e):(console.log("No Instance ID token available. Request permission to generate one."),s(!1))}).catch(function(e){console.log("An error occurred while retrieving token. ",e),showToken("Error retrieving Instance ID token. ",e),s(!1)})}).catch(function(e){console.log("Unable to get permission to notify.",e)})},window.addEventListener("message",function(e){if(console.log("message received"),console.log(e),void 0!==e&&null!=e){var t=e;if(e.constructor==="".constructor)try{t=JSON.parse(e)}catch(e){return}if(void 0!==t.data&&null!=t.data)"di:"==(""+t.data).substr(0,3)&&n.getToken().then(function(t){t?e.source.postMessage("di:"+JSON.stringify({event:"sendtoken",value:t}),"*"):e.source.postMessage("di:"+JSON.stringify({event:"sendtoken",value:null}),"*")}).catch(function(t){e.source.postMessage("di:"+JSON.stringify({event:"sendtoken",value:null}),"*")})}})}(window.DI.Push),window.DI.dom.onLoad(function(){window.DI.Push.Init()});