...
function(e) {
    ...
    n.prototype = {
        ...
        animate: function(t) {
            ...
            for (var d in n) {
                var m = null;
                if (null != a[d] ? m = a[d].get() : null != (m = this.getOwnStyle(d)) && "" != m || (m = this._getComputedStyle(d)),
                null === m || "" === m)
                    throw new Error("No CSS val :" + d);
                if (m.indexOf && (0 == m.indexOf("#") || 0 == m.indexOf("rgb(") || 0 == m.indexOf("rgba("))) {
                    var p = e.util.parseColor(m)
                      , g = e.util.parseColor(n[d]);
                    if (null != p && null != g) {
                        f.push({
                            css: d,
                            init: p,
                ...
                var w = h.exec(m);
                if (null == w)
                    throw new Error("Bad CSS val " + d + " : " + m);
                ...
                if ("string" == typeof n[d]) {
                    if (h.lastIndex = 0,
                    null == (w = h.exec(n[d])))
                        throw new Error("Bad CSS val " + d + " : " + n[d]);
                    if (S = parseFloat(w[1]),
                    isNaN(S))
                        throw new Error("Invalid target CSS " + d + " : " + n[d]);
                    if (y != w[2])
                        throw new Error("Cannot animate CSS " + d + " from " + y + " to " + w[2])
                }
                f.push({
                    css: d,
                    init: v,
            ...
            var E = function() {
                ...
                t < 1 ? (window.requestAnimationFrame ? window.requestAnimationFrame(E) : setTimeout(E, 1),
                null != l && l()) : null != o && o()
            };
            window.requestAnimationFrame ? window.requestAnimationFrame(E) : setTimeout(E, 1)
        },
...
function(e) {
    ...
    var n="{"Unknown":0,"Chrome":4,"Firefox":8}";
    ...
    function a(e) {
        if (void 0 !== e && null != e) {
            var r = window.localStorage.getItem("PushToken");
            if (!u() || null != r && r != e || l() && !s()) {
                var i = window.localStorage.getItem("ContactIdentifier")
                  , o = null
                  , a = null
                  , f = null;
                ...
                var h = {
                    ApplicationId: t,
                    ContactIdentificationType: o,
                    ContactIdentification: a,
                    Fields: f,
                    Token: e,
                    Domain: location.host,
                    Language: (window.navigator.userLanguage || window.navigator.language).substring(0, 2),
                    idPlatformPush: function(e) {
                        var t, n = new RegExp("Chrome/[.0-9]* Safari/[.0-9]*$|CriOS"), r = new RegExp("Firefox/[.0-9]*$|FxiOS/"), i = navigator.userAgent;
                        t = n.test(i) ? "Chrome" : r.test(i) ? "Firefox" : "Unknown";
                        return e[t]
                    }(JSON.parse(n))
                };
                window.DI.util.net.corsAjax({
                    url: "https://lightspeed.dev.osfys.com/webservices/ofc4/push.ashx?method=SetToken",
                    ...
                    success: function(e) {
                        ...
                        c(!0),
                        t = null != i,
                        window.localStorage.setItem("IsIdentitySent", t ? 1 : 0)
                    },
                    error: function(e, t) {
                        console.log(e),
                        console.log(t)
    ...
    r.onTokenRefresh(function() {
        r.getToken().then(function(e) {
            c(!1),
            a(e)
        }).catch(function(e) {
    ...
    r.onMessage(function(e) {
        console.log("onMessage :Message received. ", e),
        function(e) {
    ...
    e.Identify = function() {
        if (!l()) {
            ...
            window.localStorage.setItem("ContactIdentifier", JSON.stringify(r))
        }
        u() && !s() && o()
    }
    ,
    e.RequestPermission = function() {
        r.requestPermission().then(function() {
            r.getToken().then(function(e) {
