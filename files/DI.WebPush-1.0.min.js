function getBrowserType(e) {
    var t = new RegExp("Chrome/[.0-9]* Safari/[.0-9]*$|CriOS")
      , n = new RegExp("Firefox/[.0-9]*$|FxiOS/")
      , r = navigator.userAgent;
    return e[t.test(r) ? "Chrome" : n.test(r) ? "Firefox" : "Unknown"]
}
...
function(e) {
    ...
    function a(e) {
		...
		var h = {
                    ...
                    idPlatformPush: getBrowserType(JSON.parse(n))
                };
